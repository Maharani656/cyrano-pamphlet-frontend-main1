...
const HeroSection: React.FC<HeroSectionProps> = ({ heroImage }) => {
  return (
    <section className="w-full bg-[#29252D] flex items-center justify-center px-3 sm:px-4 lg:px-6 pt-10 py-16 lg:py-24 overflow-hidden">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <div className="relative mb-6 sm:mb-8 lg:mb-12">
            <motion.h1
              ...
              className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-white leading-tight mb-2 break-words"
            >
              Lorem Ipsum
            </motion.h1>
            <motion.h1
            ...
            <div className="absolute inset-0 flex items-center justify-center lg:justify-center">
              <span className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-black text-white/5 select-none break-words">YOLO</span>
            </div>
          </div>
