          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <motion.h3
                ...
                viewport={{ once: true }}
                className="text-base sm:text-lg lg:text-xl font-bold text-white mb-3 lg:mb-4 break-words"
              >
                {feature.title}
              </motion.h3>
              ...
              >
                {feature.description.map((line, lineIndex) => (
                  <p key={lineIndex} className="text-xs sm:text-sm lg:text-base text-gray-400 break-words">
                    {line}
                  </p>
                ))}
              </motion.div>
