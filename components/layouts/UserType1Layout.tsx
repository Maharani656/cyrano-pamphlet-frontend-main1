...
const UserType1Layout = () => {
  ...
  const smartClientImage = { src: '/assets/image 352.png', alt: 'Smart Client Illustration', width: 500, height: 400 };
  const dashboardImages = {
    backgroundImage: { src: '/assets/Untitled-3 1.png', alt: 'Dashboard Background'},
    phoneImage: { src: '/assets/Rectangle.png', alt: 'Phone Mockup'},
  };
  const catFeatureImage = { src: '/assets/image 292.png', alt: 'Cat illustration with glowing elements and magical atmosphere', width: 800, height: 600 };
